...
#+BEGIN_SRC sh
guix shell -D guix -- ./pre-inst-env guix edit PKG
...
#+BEGIN_SRC sh
guix shell -D guix -- ./pre-inst-env guix build PKG
guix shell -D guix -- ./pre-inst-env guix build PKG --no-grafts --check --log-file
#+END_SRC
...
#+BEGIN_SRC sh
guix shell -D guix -- ./pre-inst-env guix build --source PKG
#+END_SRC
...
#+BEGIN_SRC sh
guix shell -D guix -- ./pre-inst-env guix size PKG
#+END_SRC

** Check that dependent packages are not affected

#+BEGIN_SRC sh
guix shell -D guix -- ./pre-inst-env guix refresh --list-dependent PKG
#+END_SRC

** Lint Guix Package

#+BEGIN_SRC sh
guix shell -D guix -- ./pre-inst-env guix lint PKG
#+END_SRC

** Style Guix Package

#+BEGIN_SRC sh
guix shell -D guix -- ./pre-inst-env guix style PKG
#+END_SRC

** Test Guix Package

#+BEGIN_SRC sh
guix shell -D guix -- ./pre-inst-env guix shell --pure PKG
#+END_SRC
